...
public class Vehicle {
    ...
    public Vehicle(UUID vehicle_id, String vehicle_number, String vehicle_type,  VehicleStatus status, UUID driver_id, String driver_name, String driver_contact, String driver_nic, String driver_email) {
